...
namespace DonlSync\Catalog\Source\RDW\BuildRule;
...
/**
 * Class RDWBuildRuleFactory.
 *
 * Responsible for construction all the custom BuildRules in use by the RDW SourceCatalog
 * implementation.
 */
class RDWBuildRuleFactory
{
